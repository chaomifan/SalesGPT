...
CORS_ORIGINS = ["http://smartagent.top:3000",
                "http://38.165.32.84:3000", 
                "http://localhost:3000", 
...
async def get_bot_name(authorization: Optional[str] = Header(None)):
    ...
    sales_api = SalesGPTAPI(
        config_path=os.getenv("CONFIG_PATH", "uber/uber_agent_setup.json"),
...
if __name__ == "__main__":
    uvicorn.run(app, host="38.165.32.84", port=8000)
